...
Seguro.prototype.cotizarSeguro = function () {
    ...
    /**
     * si el seguro es básico se multiplicara por un 30% mas
     * si el seguro es completo se multiplicara por un 50% mas
     */
...
UI.prototype.mostrarResultado = (seguro, total) => {
    ...
    setTimeout(() => {
        spinner.style.display = "none"; // borra el html
        resultadoDiv.appendChild(div); // agrega el html al terminar el spiner
